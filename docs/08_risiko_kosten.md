...
- **Hardware- oder Infrastruktur-Ausfall (z. B. EC2 oder RDS Ausfall)**  
  - Eintrittswahrscheinlichkeit: gering  
    ...
    - Wie man auch in den Links sieht, dass wenn die verschiedenen Dienste unter einen gewissen Prozentsatz fallen das man dann einen gewissen Teil der bezahlten Gebüren zurück erhält
